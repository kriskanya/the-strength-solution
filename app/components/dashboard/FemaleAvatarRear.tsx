...
export default function FemaleAvatarRear({ colors }: AvatarColorsRear) {
  ...
  return (
    <div className="relative" onMouseLeave={handleLeave}>
      ...
      <QuadsFemaleRear className="absolute top-[15.2em] -left-[.2em]" fill={fillColors.quads} />
      <HamstringsFemale className="absolute top-[19.3em] left-[.6em]" fill={fillColors.hamstrings} />
      <GlutesFemale className="absolute top-[15.2em] left-[.2em]" fill={fillColors.glutes} />
      ...
      <RotatorCuffFemale className="absolute top-[7.5em] left-[.3em]" fill={fillColors.rotatorCuff}  />
      ...
      <SpinalErectorsFemale className="absolute top-[5.9em] left-4" fill={fillColors.erectors}  />

      {/*hover-over areas*/}
      <div className="w-[4.3em] h-[1.5em] absolute top-[5.5em] left-[1.2em]" data-name="traps" onMouseEnter={hoverOverDescription}></div>
      <div className={`${classes.erectorsTop} w-[8.1em] h-[7em] absolute top-[5.9em] -left-[.9em]`} data-name="erectors" onMouseEnter={hoverOverDescription}></div>
      <div className={`${classes.erectorsBottom} w-[5.8em] h-[7em] absolute top-[11.1em] left-[.5em]`} data-name="erectors" onMouseEnter={hoverOverDescription}></div>
      ...
      <div className={`${classes.rotatorCuffLeft} w-[4em] h-[3.3em] absolute top-[7.4em] -left-[0.8em]`} data-name="rotatorCuff" onMouseEnter={hoverOverDescription}></div>
      <div className={`${classes.rotatorCuffRight} w-[5.4em] h-[3.4em] absolute top-[7.5em] left-[2.8em]`} data-name="rotatorCuff" onMouseEnter={hoverOverDescription}></div>
      ...
      <div className={`${classes.quadsLeft} w-[5.5em] h-[9em] absolute top-[15.5em] -left-[1.2em]`} data-name="quads" onMouseEnter={hoverOverDescription}></div>
      <div className={`${classes.quadsRight} w-[6.5em] h-[7.9em] absolute top-[16.4em] left-[3em]`} data-name="glutes" onMouseEnter={hoverOverDescription}></div>
