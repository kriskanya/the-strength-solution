...
export default function MaleAvatarRear({ fillColors, setFillColors, originalFillColors }: Props) {
  ...
  return (
    <div className="relative" onMouseLeave={handleLeave}>
      <CalvesMaleRear className="absolute top-[21.5em] -left-[1.2em]" fill={fillColors.calvesRear} />
      ...
      <ObliquesMaleRear className="absolute top-[11em] left-[1.4em]" fill={fillColors.obliquesRear} />
      ...
      <TrapsMaleRear className="absolute top-[4.9em] left-[.6em]" fill={fillColors.trapsRear} />
      <HeadMaleRear className="absolute top-[1em] left-11" fill={fillColors.head} />
      <DeltsMaleRear className="absolute top-[6em] -left-[.5em]" fill={fillColors.deltsRear} />
      ...
      <div className="w-[2em] h-[4.3em] absolute top-[12.5em] -left-[1em]" data-name="forearmsRear" onMouseEnter={hoverOverDescription}></div>
      <div className="w-[2em] h-[4.1em] absolute top-[12.5em] left-[7.9em]" data-name="forearmsRear" onMouseEnter={hoverOverDescription}></div>
      <div className={`${classes.obliquesLeft} w-[4.7em] h-[5.1em] absolute top-[12em] -left-[.2em]`} data-name="obliquesRear" onMouseEnter={hoverOverDescription}></div>
      <div className={`${classes.obliquesRight} w-[5em] h-[5.1em] absolute top-[12em] left-[5.5em]`} data-name="obliquesRear" onMouseEnter={hoverOverDescription}></div>
      ...
      <div className={`${classes.calvesLeft} w-[6em] h-[11em] absolute top-[22em] -left-[1.2em]`} data-name="calvesRear" onMouseEnter={hoverOverDescription}></div>
      <div className={`${classes.calvesRight} w-[6em] h-[11em] absolute top-[22em] left-[3.7em]`} data-name="calvesRear" onMouseEnter={hoverOverDescription}></div>
      {
        showDescription
          ? (
