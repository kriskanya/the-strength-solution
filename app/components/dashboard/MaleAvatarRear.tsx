...
export default function MaleAvatarRear({ colors }: AvatarColorsRear) {
  ...
  return (
    <div className="relative" onMouseLeave={handleLeave}>
      ...
      <QuadsMaleRear className="absolute top-[15.3em] left-[.85em]" fill={fillColors.quads} />
      ...
      <RotatorCuffMaleRear className="absolute top-[7.7em] left-[.9em]" fill={fillColors.rotatorCuff}  />
      <SpinalErectorsMaleRear className="absolute top-[5.0em] left-[1em]" fill={fillColors.erectors}  />
      ...
      <div className={`${classes.erectorsTop} w-[5.4em] h-[7em] absolute top-[4.9em] left-[1.6em]`} data-name="erectors" onMouseEnter={hoverOverDescription}></div>
      ...
      <div className={`${classes.rotatorCuffLeft} w-[5.2em] h-[2.5em] absolute top-[8em] left-[.6em]`} data-name="rotatorCuff" onMouseEnter={hoverOverDescription}></div>
      <div className={`${classes.rotatorCuffRight} w-[5.4em] h-[2.6em] absolute top-[7.9em] left-[2.8em]`} data-name="rotatorCuff" onMouseEnter={hoverOverDescription}></div>
