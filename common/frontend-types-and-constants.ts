...
export const MUSCLE_PROFICIENCIES = {
  ...
  deltsFront: {
    NOVICE: 'You have demonstrated insufficient muscular endurance in the deltoid muscle group. An emphasis on more vertical pressing exercises such as the dip would improve this.',
    INTERMEDIATE: 'You have demonstrated less than average muscular endurance in the deltoid muscle group. An emphasis on more vertical pressing exercises such as the dip would improve this.',
    PROFICIENT: 'You have demonstrated average muscular endurance in the deltoid muscle group. An emphasis on more vertical pressing exercises such as the dip would improve this.',
    ADVANCED: 'You have demonstrated greater than average muscular endurance in the deltoid muscle group. An emphasis on more vertical pressing exercises such as the dip would further improve this.',
    ELITE: 'You have demonstrated ideal muscular endurance in the deltoid muscle group. Emphasis should be placed on bringing other muscle groups up to this level.'
  },
  quads: {
